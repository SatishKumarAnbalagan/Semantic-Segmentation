...
# hed_inp = Input(shape=(256, 448, 1), name='hed')
...
checkpoint_loss = ModelCheckpoint('model/se_only_512x912/Segmentation_val_loss.{val_loss:.4f}-{epoch:03d}.h5', monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
checkpoint_acc = ModelCheckpoint('model/se_only_512x912/Segmentation_val_acc.{val_acc:.4f}-{epoch:03d}.h5', monitor='val_acc', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
...
resnet_encoder.load_weights('model/se_only_256x448/Segmentation_val_acc.0.8073-011.h5', by_name=True)
